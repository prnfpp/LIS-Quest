...
window.DIALOGHI = {
  ...
  parole: {
    ...
    mela:      {cerca:'Mela',       testo:'Il frutto. Mano a tazza davanti alla bocca, coricata: il palmo verso la faccia, le dita che puntano di lato e il polso dalla parte da cui arriva il braccio. Sale lungo la bocca due volte. La prima cosa che la marea ti ha lasciato, e la prima che le è piaciuta.'},
